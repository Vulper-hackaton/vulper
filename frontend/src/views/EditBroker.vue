<template>
  <div>
    <div id="home-container" class="row p-5">
      <!-- Divisao da esquerda -->
        ...
        <div class="row">
          ...
          <div id="p22" class="col">
            <div>
              <img
                ...
                id="imageprofile"
                src="../../public/assets/lowPolyGorilla.png"
                alt="No photo"
              />
            </div>
          </div>
          ...
          <div id="p27" class="col-10">
            <input
              class="form-control"
              type="text"
              placeholder="Insira Taxa Administrativa"
            />
          </div>
          <p></p>
          <!-- Rentabilidade Média -->
    ...
    <div class="row justify-content-md-center p-5">
      <div class="p-2">
        <router-link to="/login">
          <button id="button1" type="button" class="btn rounded btn-block">
            Salvar
          </button>
        </router-link>
      </div>
